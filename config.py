...
# Bot Settings - OWNER_ID FIXED
OWNER_ID = int(os.getenv("OWNER_ID", "8703802029"))  # Fixed owner ID
...
# PW Mobile Headers (for OTP/Login)
PW_MOBILE_HEADERS = {
...
# PW Web Headers (for batch fetching)
PW_WEB_HEADERS = {
    "Host": "api.penpencil.co",
